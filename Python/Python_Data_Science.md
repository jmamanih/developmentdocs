...
*CICLO DE VIDA DE LA CIENICA DE DATOS*

* Conocimiento del Negocio (pregunta)
* Mineria de Datos
* Data Cleaning (limpieza de datos)
* Análisis Exploratorio de Datos
* Ingenieria de Datos
* Modelos Predictivos (Modelaje)
* Visualización

*ANALISIS EXPLORATORIO DE DATOS*

El Análisis Exploratorio de Datos (A.E.D.) es un conjunto de técnicas estadísticas cuya finalidad es conseguir un entendimiento básico de los datos y de las relaciones
existentes entre las variables analizadas. Para conseguir este objetivo el A.E.D. proporciona métodos sistemáticos sencillos para organizar y preparar los datos, detectar fallos en el diseño y recogida de los mismos, tratamiento y evaluación de datos ausentes (missing), identificación de casos atípicos (outliers) y comprobación de los supuestos subyacentes en la mayor parte de las técnicas ultivariantes (normalidad, linealidad, homocedasticidad).

*MINERIA DE DATOS*

La minería de datos (o data mining) es el proceso de analizar grandes cantidades de datos para encontrar tendencias y patrones. Permite convertir datos sin procesar y estructurarlos en información comprensible sobre diversas áreas de negocios y del mercado. La minería de datos transforma datos en bruto en conocimiento práctico.  
...
https://www.youtube.com/watch?v=_-KW4gT_oGU

https://www.codificandobits.com/blog/analisis-exploratorio-de-datos/

Para datos estructurados

*Fases del Analisis Exploratorio de Datos*

https://www.youtube.com/watch?v=_-KW4gT_oGU

* Pregunta a responder (Tener claro la pregunta que se quiere responder)
* Generalidades del Dataset (Tener una idea general del dataset)
* Tipos de datos (definir, identificar los tipos de datos)
* Estadistica descriptiva (elegir el tipo de estadistica descriptiva)
* Visualizacion (Elegir la visualizacion a utilizar)
* Interaccions (Analisar las posibles interacciones entre las variables del Dataset)
* Sumarizacion (Extraer conclusiones de todo el analisis)
