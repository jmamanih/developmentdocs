...
```
	\\servidorsamba\Compartido		//	Ingresar nombre de usuario habilitado samba ycontraseña samba
```
...
```
 (*) PERFIL DE CONFIGURACION  	
     ...
     OS:               Centos 6.7 final
     ------------------------------------------------------
     M�quina Cliente para utilizar DNS
     ------------------------------------------------------
...
Cambiar contraseña (root)
	...
	7, Asignar nueva contrase�a root y reiterar
...
```	
	...
	vncpasswd									//	Asignar contraseña de conexion
													remota
	ls -a /home/admin/.vnc/					//	Verificar creación de contrase�a
													VNC
	exit
	su -
...
Shortcuts
	...
	Mayus + F10  			= Método abreviado para el botón derecho del ratón
